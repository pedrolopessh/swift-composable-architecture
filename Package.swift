...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/pointfreeco/combine-schedulers", branch: "swift-syntax-test"),
    .package(url: "https://github.com/pedrolopessh/swift-case-paths", from: "1.3.0"),
